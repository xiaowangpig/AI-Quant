#!/usr/bin/env python3
"""Fetch SMIC (中芯国际, 688981.SH) daily data from Tushare API for the past year."""
...
output_path = "D:\\@我的电脑文件整理\\北大量化交易工作坊\\smic_data.json"
...
import csv
csv_path = "D:\\@我的电脑文件整理\\北大量化交易工作坊\\smic_data.csv"
